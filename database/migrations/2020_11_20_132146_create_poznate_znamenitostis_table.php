...
class CreatePoznateZnamenitostisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('poznate_znamenitosti', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('poznate_znamenitosti');
    }
}
