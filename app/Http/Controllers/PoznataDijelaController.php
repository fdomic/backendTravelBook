...
use App\Models\PoznataDijela;

class PoznataDijelaController extends Controller
{
    ...
    public function index(){
     ...
     public function show($id){
        ...
        //CRO: Dohvati drzavu prema id-u iz tablice PoznataDijela :
        //ENG: Get items with id from table PoznataDijela:
        $data = PoznataDijela::find($id);
    ...
    public function store(Request $request){
        ...
        $data = $request->only(`id`, `id_muzeja`, `ime`, `tvorac_dijela`, `opis_kraci`, `opis_duzi`, `datum`, `slika`, `created_at`, `updated_at`);
        ...
        if(isset($data['id'])) {
            //UPDATE
            $model = PoznataDijela::find($data['id']);
        } else {
            //CREATE
            $model = new PoznataDijela();
        }
