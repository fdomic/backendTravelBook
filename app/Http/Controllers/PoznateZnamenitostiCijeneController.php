...
use App\Models\PoznateZnamenitostiCijene;

class PoznateZnamenitostiCijeneController extends Controller
{
    public function index(){
        
        //CRO: Dohvati sve stavke iz tablice :
       //ENG: Get all items from table :
       $data = PoznateZnamenitostiCijene::all();
     ...
     public function show($id){
        ...
        //CRO: Dohvati drzavu prema id-u iz tablice PoznateZnamenitostiCijene :
        //ENG: Get items with id from table PoznateZnamenitostiCijene:
        $data = PoznateZnamenitostiCijene::find($id);
    ...
    public function store(Request $request){
        ...
        if(isset($data['id'])) {
            //UPDATE
            $model = PoznateZnamenitostiCijene::find($data['id']);
        } else {
            //CREATE
            $model = new PoznateZnamenitostiCijene();
        }
