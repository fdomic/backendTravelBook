...
use App\Models\JavniPrijevozCijene;

class JavniPrijevozCijeneController extends Controller
{
    public function index(){
        
        //CRO: Dohvati sve stavke iz tablice :
       //ENG: Get all items from table :
       $data = JavniPrijevozCijene::all();
     ...
     public function show($id){
        ...
        $data = JavniPrijevozCijene::find($id);
    ...
    public function store(Request $request){
        ...
        if(isset($data['id'])) {
            //UPDATE
            $model = JavniPrijevozCijene::find($data['id']);
        } else {
            //CREATE
            $model = new JavniPrijevozCijene();
        }
