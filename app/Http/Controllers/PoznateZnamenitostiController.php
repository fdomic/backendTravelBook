...
use App\Models\PoznateZnamenitosti;

class PoznateZnamenitostiController extends Controller
{
    public function index(){
        
        //CRO: Dohvati sve stavke iz tablice :
       //ENG: Get all items from table :
       $data = PoznateZnamenitosti::all();
     ...
     public function show($id){
        ...
        $data = PoznateZnamenitosti::find($id);
    ...
    public function store(Request $request){
       ...
       if(isset($data['id'])) $id = $data["id"];
        ...
        if(isset($data['id'])) {
            //UPDATE
            $model = PoznateZnamenitosti::find($data['id']);
        } else {
            //CREATE
            $model = new PoznateZnamenitosti();
        }
